    ...
    <Modal isOpen={isOpen} onClose={handleClose} title="Asignar Equipo a Cliente">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
          <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Equipo a asignar</h4>
          <div>
            <p className="font-medium text-gray-900 dark:text-white">{equipment.imei}</p>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full pl-10 pr-3 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
              required
            >
          ...
          {clients.length === 0 && (
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">No hay clientes disponibles</p>
          )}
        </div>
